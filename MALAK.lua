...
if res ~= 200 then
print('\27[0;31mٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
os.execute('lua MALAK.lua')
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ ┉ ┉"
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./MALAK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("DRG", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S MALAK -X kill
screen -S MALAK ./MALAK
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/malak150/Files_MALAK/main/File_Bot/commands.lua") 
...
sudo_users = {SUDO,1414888743,1856300220,1455815306,1360083579,1661260546}   
...
local hash = database:sismember(bot_id.."x_malak_xx:MN:TF"..msg.chat_id_,msg.sender_user_id_)    
if hash or SudoBot(msg) or DevSoFi(msg) or Sudo(msg) or BasicConstructor(msg) or CoSu(msg) or Bot(msg)  then       
return true    
else    
return false    
...
var = true  
elseif tonumber(user_id) == tonumber(1856300220) then
var = true  
elseif tonumber(user_id) == tonumber(1360083579) then
var = true  
elseif tonumber(user_id) == tonumber(1455815306) then
var = true  
...
var = true  
elseif database:sismember(bot_id..'x_malak_xx:MN:TF'..chat_id, user_id) then
var = true 
...
var = 'بلال مطور سورس'
elseif tonumber(user_id) == tonumber(1856300220) then
var = 'كومندا مبرمج سورس'
elseif tonumber(user_id) == tonumber(1360083579) then
var = 'ماجد مبرمج سورس'
elseif tonumber(user_id) == tonumber(1455815306) then
var = 'سنفوره مبرمجه سورس'
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
var = "المطور الاساسي²"  
...
local UserName = (data.username_ or "sanforab7")
...
local MALAK_Msg = ''  
if msgs < 100 then 
MALAK_Msg = 'غير متفاعل' 
elseif msgs < 200 then 
MALAK_Msg = 'بده يتحسن' 
elseif msgs < 400 then 
MALAK_Msg = 'شبه متفاعل' 
elseif msgs < 700 then 
MALAK_Msg = 'متفاعل' 
elseif msgs < 1200 then 
MALAK_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
MALAK_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
MALAK_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
MALAK_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
MALAK_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
MALAK_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
MALAK_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
MALAK_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
MALAK_Msg = 'رب التفاعل'  
end 
return MALAK_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"🎼┇S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿  .")  
...
function plugin_MALAK(msg)
for v in io.popen('ls File_Bot'):lines() do
if v:match(".lua$") then
plugin = dofile("File_Bot/"..v)
if plugin.MALAK and msg then
pre_msg = plugin.MALAK(msg)
end
end
end
...
--------------------------------------------------------------------------------------------------------------
function SourceMALAK(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,MALAK_Msg) 
return false  
end 
if text then    
...
os.execute('rm -rf MALAK.lua')
os.execute('wget https://raw.githubusercontent.com/malak150/MALAK/main/MALAK.lua')
send(msg.chat_id_, msg.id_,'🧜‍♀︙ تم تحديث السورس \n🧜‍♀︙ لديك اخر اصدار لسورس بلتو\n🧜‍♀︙ الاصدار » { v 1.5}')
dofile('MALAK.lua')  
end
if text == 'الاصدار🧜‍♀' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'🧜‍♀︙ اصدار سورس بلتو \n🧜‍♀︙ الاصدار »{ v 1.5}')
end
...
send(msg.chat_id_, msg.id_,'🧚︙  عدد الكروبات الان » { '..#group..' }'..MALAKk..''..MALAK..'\n🧚︙  الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات\n')   
end
end
end,nil)
end
...
usertext = '\n🧜‍♀︙ العضو » ['..result.title_..'](t.me/'..(username or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم ترقيته مطور'
...
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم ترقيته مطور'
...
local MALAK1_Msg = database:get(bot_id.."MALAK1:Add:Filter:Rp2"..text..msg.chat_id_)   
if MALAK1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🧜‍♀︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sanforab7')..') \n🧜‍♀︙ '..MALAK1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if MALAK_Msg and not Special(msg) then  
local MALAK_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if MALAK_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🧜‍♀︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🧜‍♀︙ ["..MALAK_Msg.."] \n")
else
send(msg.chat_id_,0,"🧜‍♀︙ العضو : {["..data.first_name_.."](T.ME/sanforab7)}\n🧜‍♀︙ ["..MALAK_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
database:sadd(bot_id.."MALAK:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."MALAK:blocname"..msg.chat_id_)
...
function x_malak_xx_name(t1,t2)
if t2.id_ then 
name_MRSOFI = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_MRSOFI then 
names_MRSOFI = database:smembers(bot_id.."MALAK:blocname"..msg.chat_id_) or ""
...
bnnaGet(msg.sender_user_id_, x_malak_xx_name)
end
...
database:set(bot_id.."MALAK:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."MALAK:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."MALAK:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."MALAK:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."MALAK:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function sofi_mrsofi_new(mrsofi1,mrsofi2)
if mrsofi2 and mrsofi2.first_name_ then 
if mrsofi2.first_name_:match("(.*)"..database:get(bot_id.."MALAK:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."MALAK:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local mrsofi_nnn = database:get(bot_id.."MALAK:nump"..msg.chat_id_) or 5
local mrsofi_nnn2 = database:get(bot_id.."MALAK:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(mrsofi_nnn2) == tonumber(mrsofi_nnn) or tonumber(mrsofi_nnn2) > tonumber(mrsofi_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."MALAK:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "🧚︙ عزيزي >>["..mrsofi2.username_.."](https://t.me/"..(mrsofi2.username_ or "sanforab7")..")\n🧚︙ عليك وضع التوحيد ⪼ {"..database:get(bot_id.."MALAK:teh"..msg.chat_id_).."} بجانب اسمك\n🧚︙ عدد المحاولات المتبقيه {"..(tonumber(mrsofi_nnn) - tonumber(mrsofi_nnn2)).."}")
end
end
end
end
...
local MALAKChengName = database:get(bot_id.."MALAK:Cheng:Name"..data.id_)
if not data.first_name_ then 
if MALAKChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..MALAKChengName..']')
database:del(bot_id.."MALAK:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if MALAKChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."MALAK:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local MALAKChengUserName = database:get(bot_id.."MALAK:Cheng:UserName"..data.id_)
if not data.username_ then 
if MALAKChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..MALAKChengUserName..']')
database:del(bot_id.."MALAK:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if MALAKChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."MALAK:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local MALAKChengPhoto = database:get(bot_id.."MALAK:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if MALAKChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."MALAK:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if MALAKChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."MALAK:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)  
...
Text = [[
[𝘞𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘣𝘭𝘰𝘵𝘰 𝘚𝘰𝘶𝘳𝘤𝘦](t.me/sanforab7)
]]
keyboard = {}  
keyboard.inline_keyboard = { 
{{text = '𝙱𝙴𝙻𝙰𝙻  ',url="https://t.me/BelalElshayal"}}, 
{{text = '𝚂𝙰𝙽𝙵𝙾𝚁𝙰 ',url="https://t.me/SA_FO_RA_7"}}, 
{{text = '𝙴𝙻𝙺𝙾𝙼𝙰𝙽𝙳𝙰  ',url="https://t.me/komanda3b"}}, 
{{text = '𝚂𝙾𝚄𝚁𝙲𝙴 𝙿𝙰𝚁𝙸𝚂 ',url="https://t.me/sanforab7"}}, 
} 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'🧜‍♀︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'sanforab7')..') \n🧜‍♀︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'🧜‍♀︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'sanforab7')..') \n🧜‍♀︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1856300220) then  
send(msg.chat_id_, msg.id_, "🧜‍♀︙ لا تسطيع حظر مطور السورس")
return false 
end
...
send(msg.chat_id_, msg.id_, "🧜‍♀︙ لا تسطيع حظر مطور سورس")
return false 
end
if tonumber(result.sender_user_id_) == tonumber(bot_id) then  
send(msg.chat_id_, msg.id_, "🧜‍♀︙ لا تسطيع حظر البوت عام")
...
if not database:get(bot_id..'Cick:all'..msg.chat_id_) then
if database:get(bot_id.."x_malak_xx:all:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
return 
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'x_malak_xx:all:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if DevSoFi(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/malak150/Files_MALAK/main/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n🧜‍♀︙ اهلا بك في متجر ملفات بلتو\n🧜‍♀︙ ملفات السورس ↓\nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n\n"
local TextE = "\nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n🧜‍♀︙ علامة تعني { ✔️ } ملف مفعل\n🧜‍♀︙ علامة تعني { ✖ } ملف معطل\n🧜‍♀︙ قناة سورس بلتو ↓\n".."🧜‍♀︙ [اضغط هنا لدخول](t.me/sanforab7) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/malak150/Files_MALAK/main/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('MALAK.lua')  
else
send(msg.chat_id_, msg.id_,"🧜‍♀︙ عذرا الملف لايدعم سورس بلتو \n") 
end
return false
end
...
local UserName = (b.username_ or "malak150")
...
function Function_MALAK(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_MALAK, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_MALAK, nil)
return false 
end
...
database:del(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم مسح المنظفين')
end
if text == ("المنظفين") and BasicConstructor(msg) then
local list = database:smembers(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_)
t = "\n🧜‍♀︙ قائمة المنظفين \n≪━━━━━━𝓓𝓡𝓖━━━━━━≫\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
database:sadd(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم ترقيته منظف'
send(msg.chat_id_, msg.id_, usertext..status)
...
database:sadd(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n🧜‍♀︙ العضو » ['..result.title_..'](t.me/'..(username or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم ترقيته منظف'
texts = usertext..status
else
...
database:sadd(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم ترقيته منظف'
...
function start_function(extra, result, success)
database:srem(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.sender_user_id_)
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
...
function start_function(extra, result, success)
if result.id_ then
database:srem(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.id_)
usertext = '\n🧜‍♀︙ العضو » ['..result.title_..'](t.me/'..(username or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيله من المنظفين'
texts = usertext..status
else
...
database:srem(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, userid)
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيله من المنظفين'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n🧜‍♀︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n🧜‍♀︙ العضو » '..userid..''
...
------------------------------------------------------------------------
if text == 'تنزيل عرص' and Mod(msg) then
database:del(bot_id..'Mote:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم مسح جميع المعرصين')
end
if text == ("تاك للمعرصين") and Mod(msg) then
local list = database:smembers(bot_id..'Mote:User'..msg.chat_id_)
t = "\n🧜‍♀︙ قائمة معرصين المجموعه \nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» المعرصين [@"..username.."]\n"
else
t = t..""..k.."» المعرصين `"..v.."`\n"
end
end
...
---------
if text == ("رفع عرص") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيل العضو عرص من المجموعه\n🧜‍♀︙ تعال حبي رجع العربانه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
---------
if text == ("رفع الزوجه") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
local  statuss  = '\n🧜‍♀︙ تم رفع العضــو الزوجه في الكروب \n🧜‍♀︙ تعال يحاته ممكن نتعرف'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل الزوجه")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيل العضــو الزوجه من الكروب\n🧜‍♀︙ مشيي مو خوش حاتهه'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل علقين' and Mod(msg) then
database:del(bot_id..'Modde:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم مسح جميع علقين')
end
if text == ("تاك العلوق") and Mod(msg) then
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
local  statuss  = '\n🧜‍♀︙ تم رفع العضــو علق في الكروب \n🧜‍♀︙ تعال حبي علق نطيني بوسه'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضــو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
status  = '\n🧜‍♀︙ تم تنزيل العضــو علق من الكروب\n🧜‍♀︙ مشيي مو خوش صاك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل اشواذ' and Mod(msg) then
database:del(bot_id..'Bro:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم تنزيل جميع اشواذ بالكروب')
end
if text == ("تاك لشواذ") and Mod(msg) then
local list = database:smembers(bot_id..'Bro:User'..msg.chat_id_)
t = "\n🧜‍♀︙ قائمة اشواذ الكروب \nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الشاذ [@"..username.."]\n"
else
t = t..""..k.."» الشاذ `"..v.."`\n"
end
end
...
---------
if text == ("رفع شاذ") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
local  statuss  = '\n🧜‍♀︙ تم رفع شاذ في الكروب\n🧜‍♀︙ تعال حبيبي انت صرت من اشواذ حظر روحك منا ورايح نطلع سفرات للجزيره والزوراء ونشرب عرك'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
if (text == ("تنزيل شاذ")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
-----------------------------------------------------
if text == 'تنزيل الشاذات' and Mod(msg) then
database:del(bot_id..'Girl:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم تنزيل جميع الشاذات بالكروب')
end
if text == ("تاك لااكساس") and Mod(msg) then
local list = database:smembers(bot_id..'Girl:User'..msg.chat_id_)
t = "\n🧜‍♀︙ قائمة الشاذات الكروب \nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
t = t..""..k.."» الكس [@"..username.."]\n"
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n🧜‍♀︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
local  statuss  = '\n🧜‍♀︙ تم رفع كس في الكروب\n🧜‍♀︙ تعاي صرتي من شاذاتي تمكيجي وخل نروح للمول نرقم صاكين'
send(msg.chat_id_, msg.id_, usertext..statuss)
end,nil)
end
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, start_function, nil)
...
-----------------------------------------------------
if text == 'تنزيل الاارمل' and Mod(msg) then
database:del(bot_id..'Tele:User'..msg.chat_id_)
send(msg.chat_id_, msg.id_, '🧜‍♀︙ تم تنزيل جميع ارملهان بالكروب')
end
if text == ("تاك للاارمل") and Mod(msg) then
local list = database:smembers(bot_id..'Tele:User'..msg.chat_id_)
t = "\n🧜‍♀︙ قائمة الاارمل الكروب \nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n"
for k,v in pairs(list) do
local username = database:get(bot_id.."user:Name" .. v)
if username then
...
---------
if text == ("رفعابني") and tonumber(msg.reply_to_message_id_) ~= 0 and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
if (text == ("تنزيلابني")) and msg.reply_to_message_id_ and Mod(msg) then
if AddChannel(msg.sender_user_id_) == false then
local textchuser = database:get(bot_id..'text:ch:user')
if textchuser then
send(msg.chat_id_, msg.id_,'['..textchuser..']')
...
database:set(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🧜‍♀︙ ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."MALAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."MALAK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🧜‍♀︙ تم منع الكلمه مع التحذير")  
database:del(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."MALAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."MALAK1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."MALAK1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🧜‍♀︙ ارسل الكلمه الان")  
database:set(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MALAK1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."MALAK1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."MALAK1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."MALAK1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."MALAK1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."MALAK1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n🧜‍♀︙ قائمة المنع \nٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴ\n"
for k,v in pairs(list) do  
local MALAK_Msg = database:get(bot_id.."MALAK1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..MALAK_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n🧜‍♀︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'sanforab7')..')'..'\n🧜‍♀︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if not database:get(bot_id..'x_malak_xx:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then           
...
database:setex(bot_id..'x_malak_xx:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
database:sadd(bot_id.."x_malak_xx:allM"..msg.chat_id_, msg.id_)
end
if text == ("امسح") and cleaner(msg) then  
local list = database:smembers(bot_id.."x_malak_xx:allM"..msg.chat_id_)
for k,v in pairs(list) do
local Message = v
if Message then
t = "🧚︙ تم مسح "..k.." من الوسائط الموجوده"
DeleteMessage(msg.chat_id_,{[0]=Message})
database:del(bot_id.."x_malak_xx:allM"..msg.chat_id_)
end
end
if #list == 0 then
...
local num = database:smembers(bot_id.."x_malak_xx:allM"..msg.chat_id_)
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلتو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بلتو')
local MALAK_Msg = {
'عمغي 🥺💕.',
...
send(msg.chat_id_, msg.id_,'['..MALAK_Msg[math.random(#MALAK_Msg)]..']') 
return false
end
...
if database:sismember(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.id_) then
mn = 'منظف ،' else mn = '' end
...
own = 'مدير ،' else own = '' end
if database:sismember(bot_id..'x_malak_xx:MN:TF'..msg.chat_id_, result.sender_user_id_) then
mn = 'منظف ،' else mn = '' end
...
------------------------------------------------------------------------
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_, '\n🧜‍♀︙ ارسل الكلمه تريد اضافتها')
database:set(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_, "true1")
database:set(bot_id.."botss:MALAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_, text)
database:sadd(bot_id.."botss:MALAK:List:Rd:Sudo", text)
return false end
end
if text and text:match("^(.*)$") then
if database:get(bot_id.."botss:MALAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_) == "true" then
send(msg.chat_id_, msg.id_,"🧚︙ تم حذف الرد من ردود المتعدده")
database:del(bot_id..'botss:MALAK:Add:Rd:Sudo:Text'..text)
database:del(bot_id..'botss:MALAK:Add:Rd:Sudo:Text1'..text)
database:del(bot_id..'botss:MALAK:Add:Rd:Sudo:Text2'..text)
database:del(bot_id.."botss:MALAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_)
database:srem(bot_id.."botss:MALAK:List:Rd:Sudo", text)
return false
end
end
...
local list = database:smembers(bot_id.."botss:MALAK:List:Rd:Sudo")
for k,v in pairs(list) do  
database:del(bot_id.."botss:MALAK:Add:Rd:Sudo:Text"..v) 
database:del(bot_id.."botss:MALAK:Add:Rd:Sudo:Text1"..v) 
database:del(bot_id.."botss:MALAK:Add:Rd:Sudo:Text2"..v)   
database:del(bot_id.."botss:MALAK:List:Rd:Sudo")
end
...
database:set(bot_id.."sanforab7:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."sanforab7:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."sanforab7:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."sanforab7:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"🧚︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."sanforab7:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."sanforab7:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس بلتو يعني لو بكتهن راح اعرفك انت الاخذتهن
...
database:set(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,true)
...
database:set(bot_id.."botss:MALAK:Set:On"..msg.sender_user_id_..":"..msg.chat_id_,true)
return send(msg.chat_id_, msg.id_,"🧚︙ارسل الان الكلمه لحذفها ")
end
if text then  
local test = database:get(bot_id.."botss:MALAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "true1" then
database:set(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd1')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MALAK:Add:Rd:Sudo:Text"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MALAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd1" then
database:set(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd2')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MALAK:Add:Rd:Sudo:Text1"..test, text)  
end  
...
if text then  
local test = database:get(bot_id.."botss:MALAK:Text:Sudo:Bot"..msg.sender_user_id_..":"..msg.chat_id_)
if database:get(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_) == "rd2" then
database:set(bot_id.."botss:MALAK:Set:Rd"..msg.sender_user_id_..":"..msg.chat_id_,'rd3')
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
database:set(bot_id.."botss:MALAK:Add:Rd:Sudo:Text2"..test, text)  
end  
send(msg.chat_id_, msg.id_,"🧚︙تم حفظ الرد")
return false  
end  
...
if text then
local Text = database:get(bot_id.."botss:MALAK:Add:Rd:Sudo:Text"..text)   
local Text1 = database:get(bot_id.."botss:MALAK:Add:Rd:Sudo:Text1"..text)   
local Text2 = database:get(bot_id.."botss:MALAK:Add:Rd:Sudo:Text2"..text)   
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'بلتو').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'sanforab7')..')'
local iduser = result.sender_user_id_
...
-- vardump(data) 
MALAKdx(msg.chat_id_, msg.id_, '🧜‍♀︙ ايدي المجموعة » ( '..msg.chat_id_..' )\n🧜‍♀︙ عدد الادمنيه » ( *'..data.administrator_count_..' )*\n🧜‍♀︙ عدد المحظورين » ( *'..data.kicked_count_..' )*\n🧜‍♀︙ عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Text =[[
*مرحبا بك في سورس بلتو*
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
❈ | مرحبا بك في اوامر سورس بلتو
...
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒍𝒐𝒕𝒐  ', url="t.me/sanforab7"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'ٴ●○━━━━━S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 ━━━━━○●ٴٴ\n🧚︙ [ S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿  . ](t.me/sanforab7) ')
end
...
if text == "اي رايك بدا" or text == "شنو رئيك بهذ" or text == "شنو رئيج بهذ" or text == "شنو رئيج بهذا" or text == "شنو رايك بهذا" or text == "شنو رايك بهذ" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"ادب سسز يباوع علي بنات 😂🥺"," مو خوش ولد 😶","خول وما احبه 😾😹"}
send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
if text == "اي رايك بدي" or text == "اي رايك بديي" or text == "شنو رئيج بهايي" or text == "شنو رئيج بهاي" or text == "شنو رايك بهاي" or text == "شنو رايك بهايي" then
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
...
if not database:get(bot_id..'lock:add'..msg.chat_id_) then
local texting = {"مووووووووواححح💋","مابوس ولي😌😹","خدك/ج نضيف 😂","البوسه بالف حمبي 🌝💋","خلي يزحفلي وابوسه 🙊😻","كل شويه ابوسه كافي 😏","ماابوسه والله هذا خول🦎","محح هاي لحاته صاكه💋"}send(msg.chat_id_, msg.id_, ''..texting[math.random(#texting)]..'')
end
end
...
{
{text = '𝒔𝒐𝒖??𝒄𝒆 𝒃𝒍𝒐𝒕𝒐  ', url="t.me/sanforab7"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
{
{text = ' لاوامر الرئيسيه ', callback_data="/help"},
},
{
{text = '𝒔𝒐𝒖𝒓𝒄𝒆 𝒃𝒍𝒐𝒕𝒐  ', url="t.me/sanforab7"},
},
...
local Teext =[[
مرحبا بك في S𝐎𝐔𝐑𝐂𝐄 P𝐀𝐑𝐈𝐒𖠿 
⋆ ⋆ ⋆ ⋆  ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆
❈ | مرحبا بك في اوامر سورس 
❈ | اختر الامر المرد وسيتم تحويلك اليه
ٴ   ⋆ ⋆ ⋆ ⋆  ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆ ⋆
⋆ م1 ⇽اوامر الحمايه .
⋆ م2 ⇽اوامر تعطيل ~ تفعيل .
⋆ م3 ⇽اوامر ضع ~ اضف  .
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بلتو')
if not database:get(bot_id.."Fun_Bots:"..msg.chat_id_) then
if text ==  ""..Name_Bot..' اي رايك بدا' and tonumber(msg.reply_to_message_id_) > 0 then     
function FunBot(extra, result, success) 
local Fun = {'لوكي وخول من ساع زحفلي وحضرته 😒','خوش ولد و ورده مال الله 💋🙄','يلعب ع البنات 🙄', 'ولد زايعته الكاع 😶🙊','صاك يخبل ومعضل ','محلو وشواربه جنها مكناسه 😂🤷🏼‍♀️','اموت عليه 🌝','هوه غير ا��حب مال اني 🤓❤️','مو خوش ولد صراحه ☹️','ادبسز وميحترم البنات  ', 'فد واحد قذر 🙄😒','ماطيقه كل ما اكمشه ريحته جنها بخاخ بف باف مال حشرات 😂🤷‍♀️','مو خوش ولد 🤓' } 
send(msg.chat_id_, result.id_,''..Fun[math.random(#Fun)]..'')   
end   
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
end  
if text == ""..Name_Bot..' تحب دا' and tonumber(msg.reply_to_message_id_) > 0 then    
function FunBot(extra, result, success) 
...
MALAK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(MALAK)
...
--------------------------------------------------------------------------------------------------------------
SourceMALAK(data.message_,data)
plugin_MALAK(data.message_)
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ then
...
------------------------------------------------------------------------
local MALAKAbot = database:get(bot_id.."MALAK1:Add:Filter:Rp2"..text..result.chat_id_)   
if MALAKAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🧜‍♀︙ العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🧜‍♀︙ ["..MALAKAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local MALAK1_Msg = database:get(bot_id.."MALAK1:Add:Filter:Rp2"..text..result.chat_id_)   
if MALAK1_Msg then    
send(msg.chat_id_, msg.id_,"🧜‍♀︙ "..MALAK1_Msg)
